...
get_header(); ?>
<main>
	<div class="inner-top-baner" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/policy-bg.jpg">
		<div class="container">
...
<div class="policy">
	<div class="container">
		<div class="row">
			<div class="col-md-5"> <h2>How we protect your personal information</h2></div>
			<div class="col-md-7">
